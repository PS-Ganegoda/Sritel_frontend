    ...
    <div className={`flex flex-col min-h-[98vh] bg-gray-50 dark:bg-gray-900`}>
      ...
      <div className="flex flex-col-reverse lg:flex-row w-full max-w-7xl mx-auto my-10 p-8 lg:p-16 bg-white dark:bg-gray-800 shadow-lg rounded-lg flex-grow">
        <div className="lg:w-1/2 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
          <h1 className="text-3xl lg:text-5xl font-extrabold mb-4 text-[#c96cc3] dark:text-white">
            Sri Tel Ltd (STL)
          </h1>
          ...
          <div className="flex space-x-4">
            ...
            <Button
              type="button"
              className="py-3 px-6 bg-transparent border border-[#2b4b55] text-[#2b4b55] font-semibold rounded-lg hover:bg-[#e5a8df] hover:border-[#2b4b55] dark:border-white dark:text-white dark:hover:bg-gray-700"
            >
              Learn More
            </Button>
          </div>
